...
const Popup: React.FC<AlertDialogPopupProps> = ({ className, variant = 'default', ...rest }) => {
    return <BaseAlertDialog.Popup className={clsx(s.popup, className)} data-alert-dialog-variant={variant} {...rest} />;
};
